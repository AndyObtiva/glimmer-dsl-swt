...
- Support `drag_source true` on most widgets (`spinner`, `text` (selection)) to further simplify drag and drop for default cases
- Support `drop_target true` on most widgets (`spinner`, `text` (replace or insert)) to further simplify drag and drop for default cases
