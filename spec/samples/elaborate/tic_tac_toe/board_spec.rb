...
class TicTacToe
  describe Board do
    ...
    it "tests mark_center_x" do
      ...
      @board.mark(2, 2)
      expect(@board[2, 2].empty).to be_falsey
      expect(@board[2, 2].sign).to eq("X")
      expect(@board[1, 1].empty).to be_truthy
      expect(@board[1, 2].empty).to be_truthy
      expect(@board[1, 3].empty).to be_truthy
      expect(@board[2, 1].empty).to be_truthy
      expect(@board[2, 3].empty).to be_truthy
      expect(@board[3, 1].empty).to be_truthy
      expect(@board[3, 2].empty).to be_truthy
      expect(@board[3, 3].empty).to be_truthy
    end
    ...
    it "tests mark_center_x_top_center_o_bottom_right_x" do
      ...
      @board.mark(3, 3)
      expect(@board[2, 2].empty).to be_falsey
      expect(@board[1, 2].empty).to be_falsey
      expect(@board[3, 3].empty).to be_falsey
      expect(@board[2, 2].sign).to eq("X")
    ...
    it "tests top_right_marked" do
      @board.mark(1, 3)
      expect(@board[1, 3].empty).to be_falsey
    end
