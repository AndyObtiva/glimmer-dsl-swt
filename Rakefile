...
unless juwelier_required.nil?
  Juwelier::Tasks.new do |gem|
    ...
    gem.post_install_message = ["Run the following command to complete the setup of Glimmer DSL for SWT, making the `glimmer` and `girb` commands available:\n\nglimmer-setup\n\n"]
    gem.executables = ['glimmer-setup']
