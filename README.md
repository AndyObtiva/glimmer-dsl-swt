# [<img src="https://raw.githubusercontent.com/AndyObtiva/glimmer/master/images/glimmer-logo-hi-res.png" height=85 />](https://github.com/AndyObtiva/glimmer) Glimmer DSL for SWT 4.30.1.1
...
[Glimmer DSL for SWT](https://rubygems.org/gems/glimmer-dsl-swt) 4.30.1.1 includes [SWT 4.30](https://download.eclipse.org/eclipse/downloads/drops4/R-4.30-202312010110/), which was released on December 1, 2023. Gem version numbers are in sync with the SWT library versions. The first two digits represent the SWT version number. The last two digits represent the minor and patch versions of Glimmer DSL for SWT. Note that SWT supports ARM64/AARCH64 on Mac and Linux since version `4.20`.
...
```
jgem install glimmer-dsl-swt -v 4.30.1.1
```
...
```
Glimmer (JRuby Desktop Development GUI Framework) - JRuby Gem: glimmer-dsl-swt v4.30.1.1
